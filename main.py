...
SERVICE_ACCOUNT_FILE = '/Users/monmode/Downloads/infinite-sight-431917-s2-ad710a24e6ff.json'
...
try:
    ...
    email_addresses = ['mak.ozgeozler@gmail.com', 'ozgeozler_93@hotmail.com','senaozler01@gmail.com']  # Add your desired email addresses here
    share_sheet(drive_service, spreadsheet_id, email_addresses)

    # Prepare data for Google Sheets
    sheet_data = [['Title', 'Link']]  # Header row

    for page in range(1, 5):  # Loop through the first 20 pages
